...
int main()
{
    ...
    // текстуры
    Texture t1, t2, t3;
    t1.loadFromFile("..\\TetrisCMakeRelease\\images\\tiles.png");
    t2.loadFromFile("..\\TetrisCMakeRelease\\images\\background.png");
    t3.loadFromFile("..\\TetrisCMakeRelease\\images\\frame.png");
    ...
    font.loadFromFile("..\\TetrisCMakeRelease\\sfns-display-bold.ttf");
    string points = "0";
